...
var ModuleGenerator = yeoman.generators.NamedBase.extend({
  init: function () {
    ...
    this.slugifiedPluralName = this.slugifiedSingularName = inflections.singularize(this.slugifiedName);

    //this.camelizedPluralName = this._.camelize(this.slugifiedPluralName);
    this.camelizedPluralName = this.camelizedSingularName = this._.camelize(this.slugifiedSingularName);

    //this.classifiedPluralName = this._.classify(this.slugifiedPluralName);
    this.classifiedPluralName = this.classifiedSingularName = this._.classify(this.slugifiedSingularName);

    //this.humanizedPluralName = this._.humanize(this.slugifiedPluralName);
    this.humanizedPluralName = this.humanizedSingularName = this._.humanize(this.slugifiedSingularName);
  },
